            ...
            <TableBody>
              {data.map((pos) => (
                <TableRow key={pos.code}>
                  ...
                  <TableCell className="text-right">{formatNumber(pos.avg_cost, 3)}</TableCell>
                  <TableCell className="text-right">{pos.current_price ? formatNumber(pos.current_price, 3) : '-'}</TableCell>
